...
@if ($component->getModel()->exists)
    ...
    @endif
        ...
        <small class="pull-right margin-top-20 hidden-xs"><i class="fa fa-star margin-right-10" title="{{ $component->translate('field.created_at') }}"></i>{{ $component->getModel()->getAttributeViewValue('created_at') }}</small>
    </h1>
@else
    <h2>
